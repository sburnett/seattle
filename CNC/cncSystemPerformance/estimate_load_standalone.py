...
#  ratio_inactive_nodes = .2 #at any given time, this is the expected ratio of inactive (unregistered) clients in the experiment
  ...
  get_addresses_reply_load_per_client = ((UDP_OVERHEAD+17+BYTES_PER_PUBLIC_KEY+BYTES_PER_SIGNATURE+ 6 + (BYTES_PER_ADDRESS)*(number_clients_per_group if number_clients_per_group<1000 else 1000)*(1-ratio_inactive_nodes)))/(60.0*30)
  update_packet_base_size = UDP_OVERHEAD+25+50+38 + 11
...
"""
for val in 1 10 100 1000 10000 100000; do python estimate_load_standalone.py 1000 $val ; done > server_1000grp_perf.dat
