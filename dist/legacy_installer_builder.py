...
<Purpose>
  Given the repository trunk directory, make_base_installers.py
  will create the base installers for one or more operating
  systems and deposit them in the given output directory,

  Usage: make_base_installers.py /path/to/trunk /output/dir
"""
...
def main(dist_name):
    ...
    for dist in DISTS:
        ...
        os.chdir("dist")
        clean_folder.clean_folder("initial_files.fi", prog_dir)
        ...
        os.chdir(".." + os.sep + "..")
        # Do a final check of the directory
        clean_folder.clean_folder("final_files.fi", prog_dir)
