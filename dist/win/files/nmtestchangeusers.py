...
if callfunc == 'initialize':
  ...
  nmclient_signedsay(nmhandle, "ChangeUsers", myvessel, rsa_publickey_to_string(keys[0]))

  if myvessel not in nmclient_listaccessiblevessels(nmhandle,keys[0])[1]:
  ...
  nmclient_signedsay(nmhandle, "RetrieveFileFromVessel", myvessel, "hello")
  ...
  # remove the user...
  nmclient_signedsay(nmhandle, "ChangeUsers", myvessel, '')
