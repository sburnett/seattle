...
"""
  ...
  nmclient_rawsay(nmhandle, "GetVesselResources",mynewvessels[0])
  nmclient_rawsay(nmhandle, "GetVesselResources",mynewvessels[1])
  ...
  fullresourcedata = nmclient_rawsay(nmhandle, "GetVesselResources",mynewestvessel)
  endingrestrictions = get_restrictions(fullresourcedata)

  print "Warning, this test does not check vessel resource sizes..."
  if endingrestrictions.strip() != startingrestrictions.strip():
    print "'"+endingrestrictions.strip()+"' != '"+startingrestrictions.strip()+"'"
