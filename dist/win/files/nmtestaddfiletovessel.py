...
if callfunc == 'initialize':
  ...
  data = "hellodata"
  nmclient_signedsay(nmhandle, "AddFileToVessel", myvessel, "hello",data)

  retrieveddata = nmclient_signedsay(nmhandle, "RetrieveFileFromVessel", myvessel, "hello")

  if data != retrieveddata:
    print "'"+data+"' != '"+retrieveddata+"'"
