...
if callfunc == 'initialize':
  ...
  # Change the state...
  nmclient_signedsay(nmhandle, "ChangeAdvertise", myvessel, not origstate)

  # update our information...
  vesselinfo = nmclient_getvesseldict(nmhandle)

  if vesselinfo['vessels'][myvessel]['advertise'] == origstate:
    raise Exception, "Vessel advertisement state did not change..."

  
  # Change it back...
  nmclient_signedsay(nmhandle, "ChangeAdvertise", myvessel, origstate)
  ...
  if vesselinfo['vessels'][myvessel]['advertise'] != origstate:
    raise Exception, "Vessel advertisement state was not restored!"
