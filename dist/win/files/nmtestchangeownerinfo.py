...
if callfunc == 'initialize':
  ...
  origstate = vesselinfo['vessels'][myvessel]['ownerinfo']

  nmclient_signedsay(nmhandle, "ChangeOwnerInformation", myvessel, "hello")


  # update our information...
  vesselinfo = nmclient_getvesseldict(nmhandle)

  if vesselinfo['vessels'][myvessel]['ownerinfo'] != "hello":
    raise Exception, "Ownerinfo state was not set!"

  nmclient_signedsay(nmhandle, "ChangeOwnerInformation", myvessel, origstate)
  ...
  if vesselinfo['vessels'][myvessel]['ownerinfo'] != origstate:
    raise Exception, "Ownerinfo state was not restored!"
