...
command_list = ['loadkeys guest0', 'loadkeys guest1', 'loadkeys guest2', 'as guest0', 'browse', 'on browsegood', 'show info', 'update', 'show info', 'show users', 'set users guest0 guest1 guest2', 'show users', 'show ownerinfo', 'set ownerinfo example text testing', 'show ownerinfo', 'set advertise off', 'show advertise', 'set advertise on', 'show ip', 'show ip to test_ip_file.txt', 'show hostname', 'show coordinates', 'show targets', 'show resources', 'show offcut', 'savestate testing_state', 'on %1', 'show owner', 'set owner guest2', 'show owner']
...
command_list = ['loadkeys guest0', 'as guest0', 'loadstate testing_state', 'show timeout', 'set timeout 123', 'show timeout', 'show uploadrate', 'set uploadrate 2048', 'show uploadrate']
