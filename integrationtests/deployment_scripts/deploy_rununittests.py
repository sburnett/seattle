...
def main():
  ...
  if cron_setup:
    ...
    cron_line="45 * * * * export GMAIL_USER='seattle.devel@gmail.com' && export GMAIL_PWD='repyrepy' && /usr/bin/python " + cron_tab_dir + "/rununittests.py > " + cron_log_dir + "/cron_log.rununittests" + os.linesep
