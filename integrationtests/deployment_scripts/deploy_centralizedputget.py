...
def main():
  ...
  <Usage>
    ...
    PYTHONPATH=$PYTHONPATH:/home/<user_name>/trunk && deploy_centralizedputget.py <target_folder>
  ...
  preparetest.copy_to_target("../trunk/integrationtests/centralizedputget/*", target_dir)
...
def help_exit(exit_msg):
  ...
  print "python deploy_centralizedputget.py [option] <target_directory> [<log_directory>]"
