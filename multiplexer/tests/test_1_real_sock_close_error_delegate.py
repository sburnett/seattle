# This test is to check for proper behavior of error delegation
...
# Handle error internal to the multiplexer
def mux_error(mux, errloc, excep):
  mycontext["fail3"] = True
...
if callfunc=='initialize':
  ...
  # Set the error delegate
  mux.setErrorDelegate(mux_error)
  ...
  if not mycontext["fail3"]:
    print "Error delegate was not informed of critical failure!"
