...
"""
<Program Name>
  ut_analyzer_badlog_behaviour_single_log.py
...
<Purpose>
  ...
  analyzer.py is categorizing/analyzing correctly for a log file that include 
  various 'bad' entries, such as multiple matching categories, inconsistent 
  timestamps, existing timestamps, etc.
"""
...
def main():
  ut_bad_single_log_all_time()
  ut_bad_single_log_custom_time()
  ut_bad_single_log_saved_time()
